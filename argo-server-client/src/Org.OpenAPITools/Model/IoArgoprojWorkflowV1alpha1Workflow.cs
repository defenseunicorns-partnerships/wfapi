...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.Workflow")]
    public partial class IoArgoprojWorkflowV1alpha1Workflow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1Workflow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1Workflow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1Workflow" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1Workflow(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), IoArgoprojWorkflowV1alpha1WorkflowSpec spec = default(IoArgoprojWorkflowV1alpha1WorkflowSpec), IoArgoprojWorkflowV1alpha1WorkflowStatus status = default(IoArgoprojWorkflowV1alpha1WorkflowStatus))
        {
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1Workflow and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new ArgumentNullException("spec is a required property for IoArgoprojWorkflowV1alpha1Workflow and cannot be null");
            }
            this.Spec = spec;
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowStatus Status { get; set; }
