...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.k8s.api.core.v1.ResourceFieldSelector")]
    public partial class IoK8sApiCoreV1ResourceFieldSelector : IValidatableObject
    {
        /// <summary>
        ...
        public IoK8sApiCoreV1ResourceFieldSelector(string containerName = default(string), string divisor = default(string), string resource = default(string))
        {
            ...
            if (resource == null)
            {
                throw new ArgumentNullException("resource is a required property for IoK8sApiCoreV1ResourceFieldSelector and cannot be null");
            }
