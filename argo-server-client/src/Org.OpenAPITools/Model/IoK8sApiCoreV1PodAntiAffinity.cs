...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.k8s.api.core.v1.PodAntiAffinity")]
    public partial class IoK8sApiCoreV1PodAntiAffinity : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoK8sApiCoreV1PodAntiAffinity" /> class.
        /// </summary>
        ...
        /// <param name="requiredDuringSchedulingIgnoredDuringExecution">If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied..</param>
        public IoK8sApiCoreV1PodAntiAffinity(List<IoK8sApiCoreV1WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution = default(List<IoK8sApiCoreV1WeightedPodAffinityTerm>), List<IoK8sApiCoreV1PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution = default(List<IoK8sApiCoreV1PodAffinityTerm>))
        {
        ...
        /// </summary>
        /// <value>If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node. If the anti-affinity requirements specified by this field cease to be met at some point during pod execution (e.g. due to a pod label update), the system may or may not try to eventually evict the pod from its node. When there are multiple elements, the lists of nodes corresponding to each podAffinityTerm are intersected, i.e. all terms must be satisfied.</value>
