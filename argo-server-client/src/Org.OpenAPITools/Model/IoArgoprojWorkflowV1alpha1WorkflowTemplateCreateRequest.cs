...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.WorkflowTemplateCreateRequest")]
    public partial class IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest" /> class.
        /// </summary>
        /// <param name="createOptions">createOptions.</param>
        /// <param name="varNamespace">varNamespace.</param>
        /// <param name="template">template.</param>
        public IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest(IoK8sApimachineryPkgApisMetaV1CreateOptions createOptions = default(IoK8sApimachineryPkgApisMetaV1CreateOptions), string varNamespace = default(string), IoArgoprojWorkflowV1alpha1WorkflowTemplate template = default(IoArgoprojWorkflowV1alpha1WorkflowTemplate))
        {
