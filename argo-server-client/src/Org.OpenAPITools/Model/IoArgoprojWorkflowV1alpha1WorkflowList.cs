...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.WorkflowList")]
    public partial class IoArgoprojWorkflowV1alpha1WorkflowList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1WorkflowList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowList" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowList(string apiVersion = default(string), List<IoArgoprojWorkflowV1alpha1Workflow> items = default(List<IoArgoprojWorkflowV1alpha1Workflow>), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ListMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ListMeta))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for IoArgoprojWorkflowV1alpha1WorkflowList and cannot be null");
            }
            this.Items = items;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1WorkflowList and cannot be null");
            }
        ...
        public List<IoArgoprojWorkflowV1alpha1Workflow> Items { get; set; }
