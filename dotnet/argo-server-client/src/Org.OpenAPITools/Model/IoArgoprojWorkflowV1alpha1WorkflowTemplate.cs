...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.WorkflowTemplate")]
    public partial class IoArgoprojWorkflowV1alpha1WorkflowTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowTemplate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1WorkflowTemplate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowTemplate" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowTemplate(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), IoArgoprojWorkflowV1alpha1WorkflowSpec spec = default(IoArgoprojWorkflowV1alpha1WorkflowSpec))
        {
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1WorkflowTemplate and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new ArgumentNullException("spec is a required property for IoArgoprojWorkflowV1alpha1WorkflowTemplate and cannot be null");
            }
            this.Spec = spec;
