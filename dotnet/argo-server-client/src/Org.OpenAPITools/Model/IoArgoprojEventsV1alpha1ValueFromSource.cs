...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.events.v1alpha1.ValueFromSource")]
    public partial class IoArgoprojEventsV1alpha1ValueFromSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojEventsV1alpha1ValueFromSource" /> class.
        /// </summary>
        /// <param name="configMapKeyRef">configMapKeyRef.</param>
        /// <param name="secretKeyRef">secretKeyRef.</param>
        public IoArgoprojEventsV1alpha1ValueFromSource(IoK8sApiCoreV1ConfigMapKeySelector configMapKeyRef = default(IoK8sApiCoreV1ConfigMapKeySelector), IoK8sApiCoreV1SecretKeySelector secretKeyRef = default(IoK8sApiCoreV1SecretKeySelector))
        {
