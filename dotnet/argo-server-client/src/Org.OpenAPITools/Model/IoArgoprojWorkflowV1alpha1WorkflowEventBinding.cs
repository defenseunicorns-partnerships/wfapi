...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.WorkflowEventBinding")]
    public partial class IoArgoprojWorkflowV1alpha1WorkflowEventBinding : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowEventBinding" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1WorkflowEventBinding() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowEventBinding" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowEventBinding(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), IoArgoprojWorkflowV1alpha1WorkflowEventBindingSpec spec = default(IoArgoprojWorkflowV1alpha1WorkflowEventBindingSpec))
        {
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1WorkflowEventBinding and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new ArgumentNullException("spec is a required property for IoArgoprojWorkflowV1alpha1WorkflowEventBinding and cannot be null");
            }
            this.Spec = spec;
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowEventBindingSpec Spec { get; set; }
