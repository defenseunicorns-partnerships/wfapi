...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.WorkflowEventBindingList")]
    public partial class IoArgoprojWorkflowV1alpha1WorkflowEventBindingList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowEventBindingList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1WorkflowEventBindingList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1WorkflowEventBindingList" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1WorkflowEventBindingList(string apiVersion = default(string), List<IoArgoprojWorkflowV1alpha1WorkflowEventBinding> items = default(List<IoArgoprojWorkflowV1alpha1WorkflowEventBinding>), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ListMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ListMeta))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for IoArgoprojWorkflowV1alpha1WorkflowEventBindingList and cannot be null");
            }
            this.Items = items;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1WorkflowEventBindingList and cannot be null");
            }
        ...
        public List<IoArgoprojWorkflowV1alpha1WorkflowEventBinding> Items { get; set; }
