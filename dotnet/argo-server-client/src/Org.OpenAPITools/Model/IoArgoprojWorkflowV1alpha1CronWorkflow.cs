...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.CronWorkflow")]
    public partial class IoArgoprojWorkflowV1alpha1CronWorkflow : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1CronWorkflow" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1CronWorkflow() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1CronWorkflow" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1CronWorkflow(string apiVersion = default(string), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ObjectMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ObjectMeta), IoArgoprojWorkflowV1alpha1CronWorkflowSpec spec = default(IoArgoprojWorkflowV1alpha1CronWorkflowSpec), IoArgoprojWorkflowV1alpha1CronWorkflowStatus status = default(IoArgoprojWorkflowV1alpha1CronWorkflowStatus))
        {
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1CronWorkflow and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "spec" is required (not null)
            if (spec == null)
            {
                throw new ArgumentNullException("spec is a required property for IoArgoprojWorkflowV1alpha1CronWorkflow and cannot be null");
            }
            this.Spec = spec;
        ...
        public IoArgoprojWorkflowV1alpha1CronWorkflowSpec Spec { get; set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [DataMember(Name = "status", EmitDefaultValue = false)]
        public IoArgoprojWorkflowV1alpha1CronWorkflowStatus Status { get; set; }
