...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.events.v1alpha1.NATSEventsSource")]
    public partial class IoArgoprojEventsV1alpha1NATSEventsSource : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojEventsV1alpha1NATSEventsSource" /> class.
        /// </summary>
        ...
        public IoArgoprojEventsV1alpha1NATSEventsSource(IoArgoprojEventsV1alpha1NATSAuth auth = default(IoArgoprojEventsV1alpha1NATSAuth), IoArgoprojEventsV1alpha1Backoff connectionBackoff = default(IoArgoprojEventsV1alpha1Backoff), IoArgoprojEventsV1alpha1EventSourceFilter filter = default(IoArgoprojEventsV1alpha1EventSourceFilter), bool jsonBody = default(bool), Dictionary<string, string> metadata = default(Dictionary<string, string>), string subject = default(string), IoArgoprojEventsV1alpha1TLSConfig tls = default(IoArgoprojEventsV1alpha1TLSConfig), string url = default(string))
        {
            this.Auth = auth;
        ...
        public IoArgoprojEventsV1alpha1NATSAuth Auth { get; set; }
