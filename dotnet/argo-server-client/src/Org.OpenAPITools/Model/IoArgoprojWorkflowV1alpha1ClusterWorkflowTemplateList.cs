...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "io.argoproj.workflow.v1alpha1.ClusterWorkflowTemplateList")]
    public partial class IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList" /> class.
        /// </summary>
        ...
        public IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList(string apiVersion = default(string), List<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> items = default(List<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate>), string kind = default(string), IoK8sApimachineryPkgApisMetaV1ListMeta metadata = default(IoK8sApimachineryPkgApisMetaV1ListMeta))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList and cannot be null");
            }
            this.Items = items;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList and cannot be null");
            }
        ...
        public List<IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate> Items { get; set; }
